...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{route('landing.inputberita')}}">Berita</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('landing.inputkelulusan')}}">Profile Kelulusan</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row mt-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('postDosen') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="program_studi" placeholder="Program Study">
                            </div>
                        </div>
    ...
    <footer class="text-center bg-primary" style="margin-top: 300px; padding:5px;">
