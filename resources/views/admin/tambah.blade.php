    ...
    <nav class="navbar navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="/">
                Politeknik Negeri Bengkalis | D-IV Rakayasa Perangkat Lunak</a>
        </div>
    </nav>
    <div class="container">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('postTambahAdmin') }}" method="POST">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="email" class="form-control border bordersecondary form-control" name="email" required value="{{ old('email') }}">
                                <span class="text-danger">
                                    @error('email')
                                    {{ $message }}
                                    @enderror
